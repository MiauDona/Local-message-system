...
public class Client {
    public static void main() {
        try (Socket socket = new Socket("localhost", 38528)) {
            try (OutputStream outputStream = new FileOutputStream("C:\\Users\\donan\\Desktop\\Prueba.txt")){
                ...
                try (BufferedReader bufferedReader = new BufferedReader(new FileReader("C:\\Users\\donan\\Desktop\\Prueba.txt"))){
                    String linea;
